		...
		return (
			<div className="row pb-5">
				<div className="col-12">
					<h2 className="display-4 text-capitalize title">Founders</h2>
				</div>
	            <div className="col-4 text-center text-light">
	              ...
	              <p>
	                <Link to={'/about/' + this.changeToSlug(this.props.firstName) + '-' + this.changeUrlImage(this.props.portrait_first) + '.html'} className="btn btn-outline-light btn-block">View Detail</Link>
	              </p>
	            </div>
	            <div className="col-4 text-center text-light">
	              ...
	              <p className="text-justify text-gray-dark mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt harum molestias eum, est, libero commodi beatae, tempore accusantium adipisci nesciunt velit.</p>
	              <p>
	                <Link to={'/about/' + this.changeToSlug(this.props.secondName) + '-' + this.changeUrlImage(this.props.portrait_second) + '.html'} className="btn btn-outline-light btn-block">View Detail</Link>
	              </p>
	            </div>
	            <div className="col-4 text-center text-light">
	              ...
	              <p className="text-justify text-gray-dark mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt harum molestias eum, est, libero commodi beatae, tempore accusantium adipisci nesciunt velit.</p>
	              <p>
	                <Link to={'/about/' + this.changeToSlug(this.props.thirdName) + '-' + this.changeUrlImage(this.props.portrait_third) + '.html'} className="btn btn-outline-light btn-block">View Detail</Link>
	              </p>
	            </div>
      		</div>
		)
