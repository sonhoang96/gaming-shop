		...
		return (
			<div className="row pb-5">
	            ...
	            <div className="col-4 text-center text-dark">
	              ...
	              <p>
	                <Link to={'/' + this.changeToSlug(this.props.firstName) + '-' + this.changeUrlImage(this.props.portrait_first) + '.html'} className="btn btn-outline-dark btn-block">View Detail</Link>
	              </p>
	            </div>
	            <div className="col-4 text-center text-dark">
	              ...
	              <p className="text-justify text-gray-dark mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt harum molestias eum, est, libero commodi beatae, tempore accusantium adipisci nesciunt velit.</p>
	              <p>
	                <Link to={'/' + this.changeToSlug(this.props.secondName) + '-' + this.changeUrlImage(this.props.portrait_second) + '.html'} className="btn btn-outline-dark btn-block">View Detail</Link>
	              </p>
	            </div>
	            <div className="col-4 text-center text-dark">
	              ...
	              <p className="text-justify text-gray-dark mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt harum molestias eum, est, libero commodi beatae, tempore accusantium adipisci nesciunt velit.</p>
	              <p>
	                <Link to={'/' + this.changeToSlug(this.props.thirdName) + '-' + this.changeUrlImage(this.props.portrait_third) + '.html'} className="btn btn-outline-dark btn-block">View Detail</Link>
	              </p>
	            </div>
      		</div>
		)
